...
const SectorSection = ({ id }: { id: string }) => {
          ...
          {id == "1" ? (
            <>
              ...
              <section className="flex flex-col items-center justify-between px-4 py-10 md:px-24 md:flex-row">
                <div>{solutionsArr[openTab - 1].animation}</div>
              ...
              <section className="flex flex-col items-center justify-between px-4 py-10 space-y-5 bg-gray-100 md:px-24 md:flex-row md:space-y-0">
                <div className="flex-col justify-center ">
                  ...
                  >
                    ...
                    mieux contrôler et ajuster les pratiques agricoles en
                    fonction des variations de conditions locales telles que les
                    conditions climatiques, la qualité des sols et la présence
                    de maladies ou d`insectes nuisibles.
                    <br />
                    <br />
                    L`agriculture de précision peut également aider les
                    agriculteurs à améliorer la qualité de leurs produits en
                    ajustant la gestion des cultures en fonction de leurs
                    besoins spécifiques. Cela peut aider à augmenter la valeur
                    ajoutée des cultures et à améliorer la rentabilité des
              ...
              <section className="flex flex-col items-center justify-between px-6 py-10 space-y-5 md:px-24 md:flex-row md:space-y-0">
                ...
                <div className="flex-col justify-center ">
                  ...
                  >
                    ...
                    <li>
                      Améliorer la qualité du produit pour répondre au besoin
                    ...
                    <li>
                      Fournir une meilleure expertise agronomique pour dessiner
                      un système agricole plus intelligent, prédictif et
                      durable.
                    </li>
                    <li>
                    ...
                    <li>
                      Rendre ce secteur plus attrayant pour les jeunes des
                      villes et du monde rural et contribuer à la réduction du
                      taux de chômage au Maroc.
                    </li>
                  </ul>
                </div>
              </section>
